#include "GripperSoftBodyGraspExample.h"
...
class GripperSoftBodyGraspExample : public CommonExampleInterface {
...
public:
    ...
    GripperSoftBodyGraspExample(GUIHelperInterface *helper, int options)
    ...
    virtual ~GripperSoftBodyGraspExample() {
    }
    ...
    virtual void initPhysics() {
        ...
        if ((m_options & SOFT_BODY_GRASPING) != 0) {
            {
        ...
        if ((m_options & SOFT_BODY_WITH_MULTIBODY_COUPLING) != 0) {
            {
                b3RobotSimulatorLoadUrdfFileArgs args;
    ...
    virtual void resetCamera() {
        ...
        float pitch = -10;
        float yaw = 18;
        float targetPos[3] = {0.69, -0.58, 0.63};
...
class CommonExampleInterface *GripperSoftBodyGraspExampleCreateFunc(struct CommonExampleOptions &options) {
    return new GripperSoftBodyGraspExample(options.m_guiHelper, options.m_option);
}
